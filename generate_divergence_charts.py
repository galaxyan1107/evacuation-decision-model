...
# Output directory
OUTPUT_DIR = Path("/sessions/focused-cool-keller/mnt/flea/gitbook-evacuation-model/charts")
OUTPUT_DIR.mkdir(exist_ok=True)

def load_data():
    """Load daily_data.json and run_log.json"""
    daily_path = Path("/sessions/focused-cool-keller/mnt/flea/gitbook-evacuation-model/pipeline/daily_data.json")
    run_log_path = Path("/sessions/focused-cool-keller/mnt/flea/gitbook-evacuation-model/pipeline/run_log.json")
