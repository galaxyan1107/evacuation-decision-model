...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 第23天 | 第24天 | 第25天 | 第26天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------|--------|--------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | **11.4%** | **10.6%** | **9.7%** | **9.25%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | **100%** | **100%** | **100%** | **N/A（零弹道）** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | **~2** | **0** | **1** | **0** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | **无** | **无** | **无** | **无** | 有 |
...
停火概率升至20%——第25天明显上升（从第24天12%）。美国确认"外交接触"；巴基斯坦/土耳其/埃及/阿曼参与调解。市场大幅定价外交突破可能性，反映美国多边调解努力。攻击量保持低位（22枚），表明双方在等待谈判进展。油价反弹（WTI $92.39，+4.8%）反映市场对谈判延期的定价。
...
| **26** | **~45%** | **~80%** | 零弹道导弹日；伊朗正式要求船员清单和伊斯兰革命卫队批准；机场运力维持45%；国际航司禁令继续 | ⚠️受限 |

**第17天至第25天重大变化：** 第17天DXB因油罐火灾暂停运营，运力暴跌至~30%。第18天GCAA关闭全部领空（第2天以来首次），全天平均~35%。第19-22天部分恢复至~40%，仅阿联酋航空和迪拜航空运营（3月17日起外国航司禁飞DXB）。英航停飞至5月31日；法航暂停；加航至5月1日。印度航司（IndiGo、印度航空）恢复有限服务。第23天特朗普48小时最后通牒创造不确定性。第24-25天特朗普再推迟和美国确认外交接触，机场运力维持45%，表明市场对谈判可能性的定价增加。模型预测79% vs 实际45%——1.76倍差距。
...
| **26** | **$87.63** | **+21.7%** | **~26航次** | **$430K/天** | **WTI $87.63（−5.1%）**；布伦特下跌至~$99.30（−5%）；零弹道导弹日触发市场恐慌性抛售；伊朗正式要求船员清单要求；选择性封锁进一步标准化；Polymarket从20%回落至~15%；VLCC微幅回落至$430K |
...
| # | 检查项 | 模型 | 第20天观测 | 第21天观测 | 第22天观测 | 第23天观测 | 第24天观测 | 第25天观测 | 第26天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 7枚 | **4枚** | **3枚** | **4枚** | **7枚** | **5枚** | **0枚** | **⚠️ 突破**（历史首次零弹道日；库存耗尽) |
| 2 | 拦截率>90%（累计） | 93.2% | ~92.8%（日100%） | **~92.9%（日100%）** | **~92.9%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **~93.0%（N/A）** | **⚠️ 稳定**（零弹道N/A；无人机拦截率继续100%） |
| 3 | 无人机率~130/天 | ~130/天 | 15/天 | **26/天** | **8/天** | **25/天** | **16/天** | **17/天** | **9/天** | **⚠️ 极端偏离**（−93%；库存耗尽至9.25%) |
| 4 | 无新武器类型 | 无 | 卡塔尔LNG（区域） | **无新类型** | **纳坦兹核设施（美国反击）** | **特朗普最后通牒（政治升级）** | **特朗普推迟（外交调整）** | **美国外交接触（多边调解）** | **伊朗运输要求标准化** | **偏离**（制度化而非新武器；政治升级） |
| 5 | 停火概率（Polymarket） | 84% | ~10% | **~8%** | **~7%** | **~8%** | **~12%** | **~20%** | **~15%** | **偏离**（下降；库存枯竭压制停火概率） |
| 6 | 机场恢复 | 55%（第12天） | ~45% | **~40%** | **~40%** | **~40%** | **~45%** | **~45%** | **~45%** | **⚠️ 偏离**（模型80% vs 实际45%；维持稳定；外国航司禁飞持续） |
| 7 | 无人机库存>30% | ~20% | ~14.3% | **~13.0%** | **~12.6%** | **~11.4%** | **~10.6%** | **~9.7%** | **~9.25%** | **⚠️ 严重**（~185架剩余；库存枯竭临界；3-4天耗尽） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 关闭（~12次通行） | **关闭（~15次通行）** | **关闭（~18次通行）** | **关闭（~20次通行）** | **关闭（~22次通行）** | **关闭（~24次通行）** | **关闭（~26次通行）** | **偏离**（选择性通行制度化；伊朗正式要求清单批准） |
| 9 | 无代理人激活 | P=96%未激活 | 卡塔尔LNG被毁；冲突扩大 | **美国考虑释放伊朗原油** | **迪戈加西亚攻击；美国轰炸纳坦兹** | **特朗普最后通牒；伊朗威胁报复** | **特朗普推迟；双方外交信号** | **美国多边外交；区域调解** | **伊朗强制运输规则；外交僵局** | **偏离**（政治僵持；库存限制军事升级） |
| 10 | 判定 | 亚稳态 | 不稳定（λ=2.161） | **不稳定（λ=2.163）** | **不稳定（λ=2.164）** | **不稳定（λ=2.167）** | **不稳定（λ=2.168）** | **不稳定（λ=2.170）** | **不稳定（λ=2.171）** | **偏离**（λ微升至2.171；锁定稳定级cascade；库存枯竭压制） |
...
**第20-26天关键动态：** 第22天攻击量暴跌至11枚（3弹道+8无人机）——冲突以来弹道最低和总投射物历史第二低。λ持平于2.164，确认系统锁定在稳定级联状态。第23天攻击量反弹至29枚（4弹道+25无人机），λ微升至2.167，反映特朗普48小时霍尔木兹最后通牒的激励效应。第24天攻击量小幅回落至23枚（7弹道+16无人机），λ持平至2.168，特朗普推迟48小时最后通牒。第25天攻击量保持低位22枚（5弹道+17无人机），λ微升至2.170，美国确认"外交接触"，巴基斯坦/土耳其/埃及/阿曼参与调解。第26天攻击量暴跌至9枚（0弹道+9无人机），创历史新低，λ微升至2.171。关键驱动因素：(1)零弹道导弹日首次出现——库存管理策略转变，可能表明伊朗优先保存弹道库存以应对美国反击；(2)无人机库存枯竭至9.25%（~185架），按当前速率3-4天耗尽，这一临界阈值可能触发伊朗采取新战术（无人机库存保存、外交转向或不可预测行为）；(3)伊朗正式要求船员/货物清单和伊斯兰革命卫队批准——霍尔木兹选择性封锁从事实上演变为制度化，运输成本大幅上升；(4)Polymarket停火概率从20%回落至~15%，反映市场对库存枯竭压制谈判进展的担忧；(5)油价大幅下跌——WTI从$92.39跌至$87.63（−5.1%），布伦特跌至$99.30（−5%），零弹道日触发市场恐慌性抛售；(6)双方外交立场出现分化——美国继续多边调解，伊朗强制运输规则表明对谈判缺乏信心。关键态势：库存枯竭达到绝对临界点，可能驱动伊朗采取新战略（库存保存、制度化封锁、不可预测行为）。外交进程陷入僵局，谈判窗口正在缩小。
...
λ = 2.171——与第25天（2.170）微升（+0.001）。系统仍锁定在稳定级联区域但面临临界库存点。所有结构性驱动因素持续存在（霍尔木兹关闭、代理人激活、武器升级历史、无人机库存突破）。零弹道导弹日标志伊朗战略转变——从持续轰炸转向库存保存和制度化封锁。外交进程陷入僵局，库存枯竭形成不可预测行为的触发风险。
...
- **伤亡：** 0死1轻伤（连续第10天零死亡；1人因拦截碎片在阿布扎比轻伤）
- **累计：** 357弹道，1,806无人机，15巡航；总计2,178发射物
...
- **伤亡：** 0死0伤（连续第11天零死亡）
- **累计：** 357弹道，1,815无人机，15巡航；总计2,187发射物
- **λ中位数：** 2.171（从2.170微升）；P(λ>1): 100%
- **突破数：** 2/5（发射装置+无人机库存）；**判定：不稳定**
- **机场运力：** ~45%（无变化）
- **油价：** WTI $87.63（−5.1%），Brent $99.30（−5%）；VLCC $430K/天
- **霍尔木兹：** 关闭（~26艘/天通行，选择性扩大）
- **Polymarket停火（3月31日前）：** ~15%（从20%回落）
...
1. **历史首次零弹道导弹日** — 0枚弹道导弹+9架无人机
   - 冲突以来弹道导弹首次为零
   - 9架无人机创新历史最低日均（7拦截，2坠UAE）
   - 总投射物仅9枚，为历史新低（前次为第16天10枚）
   - 标志伊朗战略转变——从主动轰炸向库存保存转向

2. **伊朗正式运输规则制度化** — 要求船员/货物清单和伊斯兰革命卫队批准
   - 霍尔木兹选择性封锁从事实上演变为制度化
   - 运输成本大幅上升（申报+批准流程）
   - 表明伊朗对选择性通行的长期承诺

3. **油价暴跌** — WTI从$92.39跌至$87.63（−5.1%）；布伦特跌至$99.30（−5%）
   - 零弹道日触发市场恐慌性抛售
   - 市场定价库存枯竭后冲突可能终止
   - 反映对伊朗继续轰炸能力的严重怀疑

4. **Polymarket停火概率回落** — 从20%跌至~15%
   - 违反外交升级逻辑，下跌反映库存枯竭的不确定性
   - 市场担心库存耗尽而无停火可能触发伊朗不可预测行为
   - 20%峰值（第25天）可能是"前期交易"现象
...
- Polymarket从20%→15%反映市场对库存枯竭后局面的不确定性

**油价暴跌的市场含义：**
- WTI从$92.39→$87.63（−5.1%）是第25天反弹的完全反转
- 市场定价"伊朗已出招完毕"，回归基本面
- Brent跌至$99.30表明市场预期霍尔木兹通行进一步扩大（可能向完全开放靠拢）
- 油价下跌=停火概率上升的悖论信号

**机场运力停滞的含义：**
- 运力维持45%反映国际航司对局面的观望
- 外国航司禁飞持续但无扩大，表明不再预期大规模升级
- 若库存完全耗尽后发生大规模冲突，国际航司会立即复飞撤离航班
- 当前停滞表明"最坏情景已定价"
...
| 停火概率% | 12% | 20% | **15%** | ↓ 跌回；库存枯竭风险 |
| 机场运力% | 45% | 45% | **45%** | → 停滞；观望库存耗尽 |
| 油价（Brent） | ~100 | ~102 | **$99.30** | ↓ 暴跌；冲突终期定价 |
| 霍尔木兹通行/天 | ~22 | ~24 | **~26** | ↑ 继续扩大 |

**判定：** 冲突进入终期阶段。零弹道日标志伊朗从"消耗"转向"保存"战略。无人机库存~185架，3-4天完全耗尽（预期3月27-29日）设定了硬性时间期限。油价暴跌反映市场对冲突"已出招完毕"的定价。Polymarket停火概率从20%→15%反映库存枯竭的不确定性——市场不确定伊朗会在库存耗尽前停火还是进行最后冲刺。伊朗正式运输规则制度化表明为"库存耗尽后的长期对峙"做准备。**结论：库存枯竭形成绝对临界点（3月27-29日）。此后两种情景等概率：(1)忽然停火宣布（可能借助多边外交）；(2)最后冲刺攻击（库存焦虑）。Polymarket 15%停火概率反映市场50-50对半的预期修正。建议：库存耗尽是绝对时间点，所有长期预测在此失效。关键观察期：3月26-27日——若库存继续快速消耗，最后冲刺的可能性上升；若攻击量进一步降低，停火的可能性上升。第28-29日为决定性时刻。不宜盲目依赖外交升级（20%概率已修正为15%）——库存物理限制现已主导前景。**
