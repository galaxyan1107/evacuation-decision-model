...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 第23天 | 第24天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | **11.4%** | **10.6%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | **~93.0%** | **~93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | **100%** | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | **~2** | **0** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | **无** | **无** | 有 |
...
停火概率升至12%——第24天明显上升（从第23天8%）。特朗普再推迟48小时，伊朗否认直接对话。市场定价外交窗口扩大，但仍不确定。攻击量从第23天29枚回落至23枚，表明双方可能在观望特朗普最后通牒的结果。伊朗威胁稳定，表示若电厂被击将全面关闭霍尔木兹+打击以色列/地区能源基础设施。
...
**第17天至第24天重大变化：** 第17天DXB因油罐火灾暂停运营，运力暴跌至~30%。第18天GCAA关闭全部领空（第2天以来首次），全天平均~35%。第19-22天部分恢复至~40%，仅阿联酋航空和迪拜航空运营（3月17日起外国航司禁飞DXB）。英航停飞至5月31日；法航暂停；加航至5月1日。印度航司（IndiGo、印度航空）恢复有限服务。第23天特朗普48小时最后通牒创造不确定性。第24天特朗普再推迟48小时，机场运力小幅回升至45%，表明市场对谈判可能性的定价略有增加。模型预测78% vs 实际45%——1.73倍差距。
...
| # | 检查项 | 模型 | 第20天观测 | 第21天观测 | 第22天观测 | 第23天观测 | 第24天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 7枚 | **4枚** | **3枚** | **4枚** | **7枚** | **⚠️ 偏离**（反弹至7枚；非模型预测的"零"而是持续微量） |
| 2 | 拦截率>90%（累计） | 93.2% | ~92.8%（日100%） | **~92.9%（日100%）** | **~92.9%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **⚠️ 稳定**（连续第7天100%日拦截率） |
| 3 | 无人机率~130/天 | ~130/天 | 15/天 | **26/天** | **8/天** | **25/天** | **16/天** | **⚠️ 极端偏离**（−88%；库存持续耗尽至10.6%） |
| 4 | 无新武器类型 | 无 | 卡塔尔LNG（区域） | **无新类型** | **纳坦兹核设施（美国反击）** | **特朗普最后通牒（政治升级）** | **特朗普推迟（外交调整）** | **偏离**（特朗普推迟48小时；外交重启信号） |
| 5 | 停火概率（Polymarket） | 84% | ~10% | **~8%** | **~7%** | **~8%** | **~12%** | **偏离**（升至12%；特朗普推迟提高外交期望） |
| 6 | 机场恢复 | 55%（第12天） | ~45% | **~40%** | **~40%** | **~40%** | **~45%** | **⚠️ 偏离**（模型78% vs 实际45%；小幅恢复；外国航司禁飞松动） |
| 7 | 无人机库存>30% | ~20% | ~14.3% | **~13.0%** | **~12.6%** | **~11.4%** | **~10.6%** | **⚠️ 严重**（~211架剩余；库存枯竭逼近；6-15天耗尽） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 关闭（~12次通行） | **关闭（~15次通行）** | **关闭（~18次通行）** | **关闭（~20次通行）** | **关闭（~22次通行）** | **偏离**（选择性通行扩大；事实上开始松动；枢纽转向日本通道） |
| 9 | 无代理人激活 | P=96%未激活 | 卡塔尔LNG被毁；冲突扩大 | **美国考虑释放伊朗原油** | **迪戈加西亚攻击；美国轰炸纳坦兹** | **特朗普最后通牒；伊朗威胁报复** | **特朗普推迟；双方外交信号** | **偏离**（双向升级但推迟；外交重启窗口） |
| 10 | 判定 | 亚稳态 | 不稳定（λ=2.161） | **不稳定（λ=2.163）** | **不稳定（λ=2.164）** | **不稳定（λ=2.167）** | **不稳定（λ=2.168）** | **偏离**（λ持平至2.168；锁定稳定级cascade；特朗普推迟驱动缓解） |
...
**第20-24天关键动态：** 第22天攻击量暴跌至11枚（3弹道+8无人机）——冲突以来弹道最低和总投射物历史第二低（仅次于第16天10枚）。λ持平于2.164，确认系统锁定在稳定级联状态。第23天攻击量反弹至29枚（4弹道+25无人机），λ微升至2.167，反映特朗普48小时霍尔木兹最后通牒的激励效应。第24天攻击量小幅回落至23枚（7弹道+16无人机），λ持平至2.168，特朗普推迟48小时最后通牒，伊朗否认直接对话但表示不排除谈判。关键驱动因素：(1)特朗普发出最后通牒后再推迟——称与伊朗有"非常好的、富有成效的对话"；(2)伊朗否认直接对话但声称特朗普"出于恐惧而退缩"；(3)Polymarket停火概率升至12%（从8%），反映外交窗口扩大；(4)油价暴跌——WTI从$98跌至$88（−10%），布伦特跌至~$100；(5)阿联酋航空+迪拜航空运营198架次，机场运力升至45%。关键态势：攻击量持续低位（第22-24天：11→29→23），无人机库存枯竭至10.6%（~211架），外交窗口扩大但仍不确定性高。
...
λ = 2.168——与第23天（2.167）基本持平（+0.001）。系统锁定在稳定级联区域。所有结构性驱动因素持续存在（霍尔木兹关闭、代理人激活、武器升级历史、无人机库存突破）。特朗普推迟48小时最后通牒，但未取消威胁——升级风险仍存在。
