...
逐日6项指标百分比偏差。红色=实际超出模型，蓝色=实际低于模型。Lambda偏离从第3天起主导（+240% → +447%）。第13天引入巡航导弹升级（单日7枚），无人机持续保守发射（42架/天）。各向量偏离持续加剧。
...
λ在第3天从0.47跳至1.70（霍尔木兹关闭），第9天达2.71（无人机库存突破+弹道持续反弹），第10天回落至2.06（弹道反弹中断、海军威慑增强），第11天持稳于2.08，第12天升至2.14（海军威慑减弱），第13天跳至2.33（巡航导弹升级：单日7枚——第3天以来首次大规模使用）。P(λ>1)从第3天起一直为100%。突破：发射装置耗尽（~99%）、无人机库存（17.1%）、新武器类型（巡航导弹+住宅楼目标）——3/5激活。

![Lambda演变](../../charts/lambda_evolution_day13.png)

### 弹道导弹轨迹

模型的指数衰减假设（β=0.25/天）从第5天起失效。第5→9天：3→7→9→16→17呈加速反弹。第10-13天（12→9→7→6枚弹道导弹）确认反弹已中断——连续四天下降，接近反弹前水平但仍高于模型预测（~1枚/天）。无人机率稳定在~42架/天（第13天），远低于模型（~130/天）。**关键转变：第13天7枚巡航导弹——伊朗在无人机库存耗尽时部署更高价值弹药。**
...
| **13** | **3月12日** | **6** | ~1 | **~42** | ~130 | **7** | **~55** | ⚠️ 巡航导弹升级：7枚巡航（第3天以来首次）；弹道第4天下降 |
...
| **13** | **3月12日** | **6** | **6** | **100%** | **93.0%** | 正常 | 弹道全拦截；⚠️ 7枚巡航导弹+Creek Harbour无人机袭击 |
...
| **13** | **3月12日** | **~42** | **~1,658** | **~342** | **17.1%** | **⚠️ 已突破** |

~~按当前速率（~120架/天），库存将在第11天（3月10日）左右触及30%阈值。~~ **第9天已突破** — 比预测提前2天。第11天发射率暴跌至35（−68%），但第12天小幅回升至45。若速率稳定在~40-45架/天，剩余384架可使用~8-9天（耗尽约第20-21天，3月19-20日）。若伊朗恢复>100架/天，则<4天耗尽（第15-16天，3月14-15日）。暴跌-回升模式表明刻意保存与精准打击并行。第13天巡航导弹升级（单日7枚）确认预测的"成本级联"——随着无人机耗尽，伊朗转向更高能力但更昂贵弹药。按~42架/天计算，剩余342架约可使用~8天（耗尽约第21天，3月20日）。
...
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.2% | **17.1%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.9% | **93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | **5/天** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | **巡航导弹** | 有 |

*发射装置消耗从85.7%修正至~73%（第8天），再至~67%（第9天），再至~99%（第10天）。无人机库存已在第9天**突破**30%阈值。第11天日拦截率突破（88.9%）。第13天新增巡航导弹向量（7枚/天）。
...
| **13** | **2.329** | **100%** | **3.039** | **不稳定** | ⚠️ 巡航导弹升级（7枚/天）；Creek Harbour住宅楼被袭；λ_巡航导弹：0→+0.20 |
...
| 情景 | 第6天 | 第14天 | 第30天 | 第13天评估 |
|------|-------|--------|--------|-----------|
| 停火 | 3.3% | 7.8% | 12.8% | ↓↓↓ Polymarket ~18% — 连续第9天下降；巡航导弹升级进一步降低前景 |
| 基线 | 64.9% | 71.2% | 75.4% | ↓↓↓ 巡航导弹转向+住宅楼被袭+霍尔木兹关闭——基线框架已破裂 |
| 升级 | 31.4% | 20.1% | 11.7% | ↑↑↑↑ 巡航导弹+住宅楼+机场+炼油厂——全频谱精准打击 |
| 全面战争 | 0.4% | 0.9% | 0.1% | ↑↑ 住宅楼被袭（Creek Harbour）+巡航导弹升级显示升级意愿；λ=2.329 |
...
停火概率持续下降 — 连续第9天（67%→18%）。市场坚定定价持久冲突，短期内无解决方案。3月15日市场约10%意味着未来5天停火概率微乎其微。
...
| **13** | **3月12日** | **~55%** | **60%** | Creek Harbour住宅楼被袭；DXB运营但限制航线 | **接近** |

**正向偏离：** 机场恢复曾为模型预测的1.4倍（第1-11天）。第12天DXB机场遭无人机袭击导致运力降至~60%。第13天Creek Harbour住宅楼被袭。机场运力进一步降至~55%，国际航司持续暂停，空域限制缩减吞吐量。模型趋同：实际运力首次接近模型预测（55% vs 60%），自第7天以来首次。
...
| **13** | **3月12日** | **~$88** | **+22.2%** | **零通行** | **~$415K/天** | **WTI稳定在~$88；布伦特~$91；高盛上调Q4预测；美国对伊朗发动"最猛烈打击"** |
...
| **13** | **3月12日** | **⚠️ 巡航** | **7枚巡航导弹被拦截——第3天以来首次大规模使用** | **λ_巡航导弹：0→+0.20；成本级联开始** |
| 13 | 3月12日 | 无人机 | 伊朗无人机击中迪拜Creek Harbour 2住宅楼——火灾受控 | 精准打击扩展至住宅基础设施 |
| 13 | 3月12日 | 弹道 | 6枚弹道导弹（全部拦截）——连续第四天下降 | 弹道接近反弹前水平 |
| 13 | 3月12日 | 军事 | 美国对伊朗发动"最猛烈一天打击"——目标为无人机工厂；声称发射量减少90% | 潜在生产降级 |
| 13 | 3月12日 | 石油 | WTI稳定在~$88；高盛上调Q4布伦特预测 | IEA释放后稳定；较长霍尔木兹中断已定价 |
...
|---|--------|------|------------|------------|------|
| 1 | 弹道导弹单调递减 | 是 | 9→7（第3天下降） | 7→6（第4天下降） | **偏离**（趋同中） |
| 2 | 拦截率>90%（累计） | 93.2% | 92.9% | 93.0% | **吻合** |
| 3 | 无人机率~130/天 | ~130/天 | 45/天 | **~42/天** | **⚠️ 极端偏离**（低于模型−68%） |
| 4 | 无新武器类型 | 无 | DXB机场 | **巡航导弹+Creek Harbour** | **⚠️ 升级**（弹药类型+住宅楼） |
| 5 | 停火概率（Polymarket） | 84% | 20% | **~18%** | **偏离**（连续第9天下降） |
| 6 | 机场恢复 | 55%（第12天） | ~60% | **~55%** | **接近**（模型趋同，运力下降） |
| 7 | 无人机库存>30% | ~17% | 19.2% | **17.1%** | **⚠️ 严重**（耗尽持续+巡航转型） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 已关闭 | **已关闭** | **偏离**（11天关闭） |
| 9 | 无代理人激活 | P=96%未激活 | 胡塞威胁中 | 胡塞威胁中 | **偏离** |
| 10 | 判定 | 亚稳态 | 不稳定 | **不稳定** | **偏离**（λ=2.329） |

**第13天评级：1项吻合，1项接近，8项偏离**
...
| **13** | **~40** | **2.329** | **不稳定** | **立即撤离** |

λ跳升至2.329（从2.141）——自第8天（+0.868）以来最大增幅——由巡航导弹升级驱动。系统**深入级联区域**，伊朗武器组合持续演变。

**第13天关键动态：**
- **正面：** 弹道导弹持续下降（7→6，连续第四天，全部拦截100%）。美国对伊朗发动"最猛烈一天打击"——目标为无人机/导弹生产设施，声称发射能力减少90%。IEA释放后油价稳定在~$88。Creek Harbour住宅楼被袭未造成伤亡
- **负面：** **⚠️ 巡航导弹升级** — 单日7枚巡航导弹，第3天以来首次大规模使用。巡航导弹比无人机更难拦截（雷达截面小、地形跟踪飞行），每枚拦截成本$3.9M（vs 无人机$0.7M）。这是预测的"成本级联"——随无人机库存耗尽（17.1%）启动。Creek Harbour住宅楼遭无人机袭击——豪华住宅区新增为打击目标。Polymarket停火降至~18%（连续第9天下降）
- **关键评估：** 伊朗武器转型符合模型预测的成本级联。每枚弹药的日防御成本在总弹药数下降同时急剧上升。7枚巡航（$27.3M）+ 6枚弹道（~$60-76M，THAAD/PAC-3混合）+ 42架无人机（$29.4M）= ~$117-133M/天拦截成本（1:1比例）。巡航导弹向量是第3天霍尔木兹关闭以来最重大变化
- **窗口状态：** 机场运力~55%且持续收窄。空域限制减少吞吐量。**立即利用此窗口——巡航导弹升级不可预测，使未来窗口更不确定**
