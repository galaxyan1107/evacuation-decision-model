...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 第23天 | 第24天 | 第25天 | 第26天 | 第27天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------|--------|--------|--------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | **11.4%** | **10.6%** | **9.7%** | **9.25%** | **8.7%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | **100%** | **100%** | **100%** | **N/A（零弹道）** | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | **~2** | **0** | **1** | **0** | **2** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | **无** | **无** | **无** | **无** | **杰贝阿里港火灾** | 有 |
...
停火概率稳定在~17%——第26天无变化。攻击量反弹（26枚，从零弹道日升至15弹道）。库存补充信号（可能战术调整而非新生产）。Jebel Ali港因拦截碎片火灾。胡塞武装信号准备加入伊朗战争——区域升级可能性。市场定价库存枯竭与外交进程的竞争关系。攻击量反弹可能代表伊朗战术灵活性而非长期升级。油价稳定反映市场对冲突动态的消化。
...
| # | 检查项 | 模型 | 第20天观测 | 第21天观测 | 第22天观测 | 第23天观测 | 第24天观测 | 第25天观测 | 第26天观测 | 第27天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 7枚 | **4枚** | **3枚** | **4枚** | **7枚** | **5枚** | **0枚** | **15枚** | **⚠️ 突破**（零弹道后反弹；库存补充信号；库存管理调整） |
| 2 | 拦截率>90%（累计） | 93.2% | ~92.8%（日100%） | **~92.9%（日100%）** | **~92.9%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **~93.0%（N/A）** | **~93.0%（日100%）** | **⚠️ 稳定**（恢复日拦截率；弹道库存补充；无新突破） |
| 3 | 无人机率~130/天 | ~130/天 | 15/天 | **26/天** | **8/天** | **25/天** | **16/天** | **17/天** | **9/天** | **11/天** | **⚠️ 极端偏离**（−92%；库存枯竭至8.7%；但攻击量反弹至26枚） |
| 4 | 无新武器类型 | 无 | 卡塔尔LNG（区域） | **无新类型** | **纳坦兹核设施（美国反击）** | **特朗普最后通牒（政治升级）** | **特朗普推迟（外交调整）** | **美国外交接触（多边调解）** | **伊朗运输要求标准化** | **胡塞激活（区域升级）** | **偏离**（代理人激活；也门参与；区域升级扩大） |
| 5 | 停火概率（Polymarket） | 84% | ~10% | **~8%** | **~7%** | **~8%** | **~12%** | **~20%** | **~17%** | **~17%** | **偏离**（停火概率停滞；攻击量反弹+胡塞激活压制） |
| 6 | 机场恢复 | 55%（第12天） | ~45% | **~40%** | **~40%** | **~40%** | **~45%** | **~45%** | **~50%** | **~50%** | **⚠️ 偏离**（模型80% vs 实际50%；Emirates继续恢复；胡塞激活可能再次延缓） |
| 7 | 无人机库存>30% | ~20% | ~14.3% | **~13.0%** | **~12.6%** | **~11.4%** | **~10.6%** | **~9.7%** | **~9.25%** | **~8.7%** | **⚠️ 危急**（~174架剩余；库存枯竭加速；但攻击量反弹表明战术调整） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 关闭（~12次通行） | **关闭（~15次通行）** | **关闭（~18次通行）** | **关闭（~20次通行）** | **关闭（~22次通行）** | **关闭（~24次通行）** | **关闭（~26次通行）** | **关闭（~28次通行）** | **偏离**（选择性通行继续扩大；制度化管理；事实上半开放） |
| 9 | 无代理人激活 | P=96%未激活 | 卡塔尔LNG被毁；冲突扩大 | **美国考虑释放伊朗原油** | **迪戈加西亚攻击；美国轰炸纳坦兹** | **特朗普最后通牒；伊朗威胁报复** | **特朗普推迟；双方外交信号** | **美国多边外交；区域调解** | **伊朗强制运输规则；外交僵局** | **胡塞激活；也门参与（代理人升级）** | **激活**（真主党→胡塞武装激活；区域冲突扩大） |
| 10 | 判定 | 亚稳态 | 不稳定（λ=2.161） | **不稳定（λ=2.163）** | **不稳定（λ=2.164）** | **不稳定（λ=2.167）** | **不稳定（λ=2.168）** | **不稳定（λ=2.170）** | **不稳定（λ=2.171）** | **不稳定（λ=2.172）** | **偏离**（λ微升至2.172；库存补充+代理人激活；长期冲突定价升高） |
...
λ = 2.172——与第26天（2.171）微升（+0.001）。系统继续锁定在稳定级联区域。第27天关键变化：(1)零弹道日后攻击量反弹至26枚（15弹道+11无人机），表明伊朗库存补充或战术调整；(2)胡塞武装激活信号——代理人作用扩大，真主党之后也门参与，区域冲突升级；(3)Jebel Ali港火灾——拦截碎片二次伤害；(4)库存补充可能标志伊朗从"消耗-保存"转向"适度补充-持久战"；(5)胡塞激活重新定价长期冲突可能性，压制停火概率（维持17%）。所有结构性驱动因素持续强化（霍尔木兹关闭、代理人激活范围扩大、库存补充、武器升级），λ微升反映战术灵活性风险上升。
