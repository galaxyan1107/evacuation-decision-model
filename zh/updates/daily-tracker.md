...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 第23天 | 第24天 | 第25天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | **11.4%** | **10.6%** | **9.7%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | **100%** | **100%** | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | **~2** | **0** | **1** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | **无** | **无** | **无** | 有 |
...
| # | 检查项 | 模型 | 第20天观测 | 第21天观测 | 第22天观测 | 第23天观测 | 第24天观测 | 第25天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 7枚 | **4枚** | **3枚** | **4枚** | **7枚** | **5枚** | **⚠️ 偏离**（反弹至5枚；非模型预测的"零"而是持续微量） |
| 2 | 拦截率>90%（累计） | 93.2% | ~92.8%（日100%） | **~92.9%（日100%）** | **~92.9%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **~93.0%（日100%）** | **⚠️ 稳定**（连续第8天100%日拦截率） |
| 3 | 无人机率~130/天 | ~130/天 | 15/天 | **26/天** | **8/天** | **25/天** | **16/天** | **17/天** | **⚠️ 极端偏离**（−87%；库存持续耗尽至9.7%） |
| 4 | 无新武器类型 | 无 | 卡塔尔LNG（区域） | **无新类型** | **纳坦兹核设施（美国反击）** | **特朗普最后通牒（政治升级）** | **特朗普推迟（外交调整）** | **美国外交接触（多边调解）** | **偏离**（外交升级；多边调解参与） |
| 5 | 停火概率（Polymarket） | 84% | ~10% | **~8%** | **~7%** | **~8%** | **~12%** | **~20%** | **偏离**（升至20%；美国外交接触驱动大幅提升） |
| 6 | 机场恢复 | 55%（第12天） | ~45% | **~40%** | **~40%** | **~40%** | **~45%** | **~45%** | **⚠️ 偏离**（模型79% vs 实际45%；维持稳定；外国航司禁飞持续） |
| 7 | 无人机库存>30% | ~20% | ~14.3% | **~13.0%** | **~12.6%** | **~11.4%** | **~10.6%** | **~9.7%** | **⚠️ 严重**（~194架剩余；库存枯竭迫在眉睫；4-6天耗尽） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 关闭（~12次通行） | **关闭（~15次通行）** | **关闭（~18次通行）** | **关闭（~20次通行）** | **关闭（~22次通行）** | **关闭（~24次通行）** | **偏离**（选择性通行进一步扩大；事实上渐进式开放） |
| 9 | 无代理人激活 | P=96%未激活 | 卡塔尔LNG被毁；冲突扩大 | **美国考虑释放伊朗原油** | **迪戈加西亚攻击；美国轰炸纳坦兹** | **特朗普最后通牒；伊朗威胁报复** | **特朗普推迟；双方外交信号** | **美国多边外交；区域调解** | **偏离**（外交升级主导；军事冲突降温） |
| 10 | 判定 | 亚稳态 | 不稳定（λ=2.161） | **不稳定（λ=2.163）** | **不稳定（λ=2.164）** | **不稳定（λ=2.167）** | **不稳定（λ=2.168）** | **不稳定（λ=2.170）** | **偏离**（λ微升至2.170；锁定稳定级cascade；外交升级驱动缓解） |
...
**第20-25天关键动态：** 第22天攻击量暴跌至11枚（3弹道+8无人机）——冲突以来弹道最低和总投射物历史第二低。λ持平于2.164，确认系统锁定在稳定级联状态。第23天攻击量反弹至29枚（4弹道+25无人机），λ微升至2.167，反映特朗普48小时霍尔木兹最后通牒的激励效应。第24天攻击量小幅回落至23枚（7弹道+16无人机），λ持平至2.168，特朗普推迟48小时最后通牒。第25天攻击量保持低位22枚（5弹道+17无人机），λ微升至2.170，美国确认"外交接触"，巴基斯坦/土耳其/埃及/阿曼参与调解。关键驱动因素：(1)美国多边外交升级——与伊朗有"外交接触"，可能在巴基斯坦进行万斯-伊朗会议；(2)地区国家调解参与扩大；(3)Polymarket停火概率飙升至20%（从12%），反映市场大幅调整外交期望；(4)油价反弹——WTI从$88升至$92.39（+4.8%），布伦特升至~$102；(5)攻击量保持低位（第22-25天：11→29→23→22），表明双方在等待谈判进展；(6)无人机库存枯竭至9.7%（~194架），按当前速率4-6天耗尽。关键态势：外交升级主导政治动向，军事冲突逐步降温，但库存枯竭与谈判进展形成竞争关系。
...
λ = 2.170——与第24天（2.168）微升（+0.002）。系统仍锁定在稳定级联区域。所有结构性驱动因素持续存在（霍尔木兹关闭、代理人激活、武器升级历史、无人机库存突破）。美国多边外交升级，但库存枯竭与谈判进展形成竞争关系。
