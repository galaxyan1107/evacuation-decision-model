...
逐日6项指标百分比偏差。红色=实际超出模型，蓝色=实际低于模型。Lambda偏离从第3天起主导（+240% → +447%）。第14天无人机极端偏离（实际27 vs 模型~130），稳定在第13天历史低位26附近。弹道导弹降至7枚，恢复下降趋势。
...
λ在第3天从0.47跳至1.70（霍尔木兹关闭），第9天达2.71（无人机库存突破+弹道持续反弹），第10天回落至2.06（弹道反弹中断、海军威慑增强），第11天持稳于2.08，第12天升至2.14（海军威慑减弱：3→2航母），第13天降至2.11，第14天继续降至2.08（弹道恢复下降10→7，拦截率改善至93.3%）。P(λ>1)从第3天起一直为100%。连续第三天λ边际改善（2.14→2.11→2.08）。攻击量创新历史最低（34枚总量）。

![Lambda演变](../../charts/lambda_evolution_day14.png)

### 弹道导弹轨迹

模型的指数衰减假设（β=0.25/天）从第5天起失效。第5→9天：3→7→9→16→17呈加速反弹。第10-11天（12→9枚弹道导弹）确认反弹已中断——连续两天下降。第12天9→6枚弹道导弹，连续第三天下降。第13天：6→10枚弹道导弹，一天逆转。第14天：**10→7枚弹道导弹**，恢复下降趋势。五天模式：12→9→6→10→7——明显向下但有噪声。无人机稳定在历史低位（26→27）。无巡航导弹（连续第二天）。总投射物创新低（34枚）。
...
| **14** | **2.080** | **100%** | **2.780** | **不稳定** | 弹道恢复下降（10→7）；拦截改善（93.3%）；无人机稳定在历史低位（27）；哈梅内伊确认霍尔木兹关闭；DIFC残骸；KC-135坠毁 |
...
| **14** | **~40** | **2.080** | **不稳定** | **立即撤离** |

λ继续降至2.080（从2.110），连续第三天边际改善（2.14→2.11→2.08）。弹道恢复下降（10→7），拦截率改善至93.3%（累计最佳）。系统仍**牢固处于级联区域**，结构性不稳定因素不变——霍尔木兹被哈梅内伊政治锁定关闭、代理人激活（伊拉克民兵声称击落KC-135）、无人机库存耗尽。

**第14天关键动态：**

- **正面：** 弹道恢复下降（10→7，−30%），五天模式向下。拦截率累计93.3%（开战以来最佳）。攻击总量创新历史最低（~34枚）。零伤亡。无人机稳定在历史低位（~27），连续第四天<40架。无巡航导弹（连续第二天）
- **负面：** 哈梅内伊首次公开确认霍尔木兹继续关闭——消除近期重新开放的任何希望。油价反弹$86→$95（抹去IEA干预约75%收益）。KC-135加油机坠毁4人遇难。DIFC碎片事件。Polymarket停火概率降至~17%（连续第10天下降）。机场运力降至~50%（阿布扎比和迪拜避难警报）
- **关键评估：** λ边际改善被政治锁定抵消——哈梅内伊声明表明霍尔木兹关闭为政治决策而非军事必要，短期内不会解除。攻击量持续崩溃但级联风险的结构性驱动因素（霍尔木兹、代理人、库存耗尽）均未改善
- **窗口：** 机场运力~50%，仍可运营但趋势收窄。攻击量历史低位提供**相对平静的撤离窗口**——但油价反弹和政治强硬化表明冲突可能长期化。立即撤离
