...
逐日6项指标百分比偏差（16天）。红色=实际超出模型，蓝色=实际低于模型。Lambda偏离从第3天起主导（+240% → +330%）。无人机从第11天起极端偏离（实际26-35 vs 模型~130）。弹道导弹在6-10范围内震荡（第12-16天），远超模型接近零的预测。
...
堆叠偏离显示Lambda（紫色）主导总模型误差。判定时间线：模型全14天预测亚稳态——现实在第3天跨入不稳定且未恢复。

![偏离记分卡](../../charts/divergence_scorecard.png)

### Lambda演变

λ在第3天从0.47跳至1.70（霍尔木兹关闭），第9天达2.71峰值（无人机库存突破+弹道反弹），随后回落并从第10天起稳定在~2.1平台。第12-16天λ在2.14-2.15范围内保持稳定，反映攻击量下降与结构性不稳定因素的相互抵消。第16天：λ=2.152（革命卫队声称第二次打击扎夫拉空军基地）。P(λ>1)从第3天起持续100%。系统牢固锁定在级联区域。

![Lambda演变](../../charts/lambda_evolution_day16.png)

### 弹道导弹轨迹

模型的指数衰减假设（β=0.25/天）从第5天起失效。第5→9天：3→7→9→16→17呈加速反弹。反弹后（第10-16天）：弹道导弹在6-12范围内震荡，呈噪声下降趋势（12→9→6→10→7→9→10）。模型预测第12天后接近零——实际仍为预测的7-10倍。无人机从第10天（110）暴跌至第13-16天26-33范围，远低于模型的130/天。总日投射物维持在34-42范围。
...
| **16** | **3月15日** | **~10** | ~0 | **~30** | ~130 | 0 | **~40** | 革命卫队声称10枚导弹+无人机打击扎夫拉空军基地；@modgovae待确认 |
...
| 15 | 3月14日 | 291 | ~1,696 | 15 | ~2,002 |
| **16** | **3月15日** | **~301** | **~1,726** | **15** | **~2,042** |
...
| **16** | **3月15日** | **~10** | **~9** | **~90%** | **93.0%** | 正常 | 革命卫队声称扎夫拉打击；@modgovae待确认 |
...
| **16** | **3月15日** | **~30** | **~1,726** | **~274** | **13.7%** | **⚠️ 已突破** |
...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | **16.9%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | **93.3%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | **~100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | **0/天** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | **无** | 有 |
...
| 15 | 2.149 | 100% | 2.870 | 不稳定 | 9枚弹道+33架无人机(@modgovae)；富查伊拉碎片火灾；攻击扩至阿曼（2死）/沙特；日拦截率88.9% |
| **16** | **2.152** | **100%** | **2.870** | **不稳定** | 革命卫队声称10枚导弹+无人机打击扎夫拉空军基地（第二次）；AN/TPY-2雷达据报被毁；美以大规模打击伊朗 |
...
停火概率持续下降 — 连续第10天（67%→~17%）。市场坚定定价持久冲突。哈梅内伊首次公开确认霍尔木兹继续关闭，进一步压低停火预期。尽管攻击量创新历史最低（~34枚），政治强硬化信号表明无近期解决方案。油价反弹$86→$95反映市场对IEA干预效果的信心消退。
...
| **16** | **3月15日** | **升级** | **革命卫队声称10枚导弹+无人机打击扎夫拉空军基地（第二次）** | **λ_武器：扎夫拉再次被打击** |
| 16 | 3月15日 | 军事 | AN/TPY-2雷达、MQ-9无人机和U-2设施据报被毁 | $5亿+美军资产受损；预警能力下降 |
| 16 | 3月15日 | 空袭 | 美以大规模打击伊斯法罕、设拉子、德黑兰、德兹富勒、霍梅因、哈马丹 | 对伊朗军事目标的反击升级 |
| 16 | 3月15日 | 航空 | 阿联酋航空~200架次/天（~60%）；迪拜航空~64架次（~35%） | 机场运力停滞在55-60% |
| 16 | 3月15日 | 石油 | 布伦特~$103；WTI~$99；伊朗警告油价可达$200 | 持续高于布伦特$100 |

---

## 模型与现实对照记分卡（滚动更新）

| # | 检查项 | 模型 | 第13天观测 | 第14天观测 | 状态 |
|---|--------|------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 6→10（逆转，+67%） | **10→7（恢复下降）** | **⚠️ 偏离**（非单调：12→9→6→10→7） |
| 2 | 拦截率>90%（累计） | 93.2% | 93.1% | **93.3%** | **吻合**（连续改善） |
| 3 | 无人机率~130/天 | ~130/天 | **26/天** | **~27/天** | **⚠️ 极端偏离**（−79%，历史低位） |
| 4 | 无新武器类型 | 无 | 无新类型 | 无新类型 | 稳定 |
| 5 | 停火概率（Polymarket） | 84% | ~19% | **~17%** | **偏离**（连续第10天下降） |
| 6 | 机场恢复 | 55%（第12天） | ~55% | **~50%** | **偏离**（DIFC碎片+避难警报拉低） |
| 7 | 无人机库存>30% | ~20% | 18.2% | **16.9%** | **⚠️ 严重** |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | **已关闭** | **已关闭（哈梅内伊确认）** | **偏离** |
| 9 | 无代理人激活 | P=96%未激活 | 胡塞威胁中 | 伊拉克民兵声称击落KC-135 | **偏离** |
| 10 | 判定 | 亚稳态 | **不稳定** | **不稳定** | **偏离** |

**第14天评级：1项吻合，1项稳定，0项接近，8项偏离**

重大变化：**弹道恢复下降趋势**（10→7，−30%），五天模式12→9→6→10→7呈明显下降趋势但有噪声。无人机稳定在历史低位（26→27），连续第四天<40架。无巡航导弹（连续第二天）。每日投射物总计~34枚——**创新历史最低**。零伤亡。哈梅内伊首次公开确认霍尔木兹继续关闭。DIFC碎片事件无伤亡。KC-135加油机在伊拉克坠毁，4名机组遇难。油价反弹~$86→$95（哈梅内伊声明抹去IEA干预约75%收益）。**@modgovae第14天累计：285枚弹道，15枚巡航，1567架无人机。** 净评估：攻击量持续崩溃（34枚创新低），λ连续第三天边际改善（2.14→2.11→2.08），但结构性不稳定因素不变——霍尔木兹被政治锁定关闭，油价反弹侵蚀IEA干预成效。
...
| 15 | ~38 | 2.149 | 不稳定 | 立即撤离 |
| **16** | **~37** | **2.152** | **不稳定** | **立即撤离** |

λ=2.152——与第12-15天几乎不变，在~2.15形成平台。系统锁定在级联区域，结构性驱动因素（霍尔木兹关闭、代理人激活、武器升级历史）阻止任何有意义的下降。革命卫队第二次声称打击扎夫拉增加λ_weapon分量。

**第16天关键动态：**

- **正面：** 攻击量维持低位（40枚日投射物）。累计拦截率稳定在93.0%。第16天零死亡。阿联酋航空通过紧急走廊维持~200架次/天。无人机耗尽限制伊朗持续攻击能力
- **负面：** 革命卫队声称第二次打击扎夫拉——AN/TPY-2雷达（$5亿+）、MQ-9/U-2设施据报被毁。若确认，削弱美军在战区的预警能力。伊朗攻击扩展至阿曼（第15天2人死亡）和沙特。布伦特持续高于$100，伊朗警告$200。停火概率14%（连续第12天下降）。美以大规模打击伊朗城市表明升级而非降级
- **关键评估：** 第14天指出的**战术-战略分化**正在加深。战术上，伊朗日攻击量受库存耗尽限制（~274架无人机剩余，14%库存）。战略上，冲突正在**扩大**——攻击阿曼/沙特、精确打击美军资产、大规模反击伊朗城市表明双方都在升级
- **无人机耗尽时间线：** 按~30架/天，剩余~274架持续约9天（耗尽约第25天，3月24日）。伊朗转向精确弹道导弹打击军事目标（扎夫拉）而非面积饱和攻击，暗示对库存下降的战略适应
- **窗口：** 机场~55%但停滞。低攻击量提供**撤离窗口**，但革命卫队军事目标聚焦和区域扩展警告可能升级至新阶段。趁航班运营立即离开
