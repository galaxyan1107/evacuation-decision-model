...
第11-22天持续低量模式（6-45架/天）。按@modgovae核实的累计1,748架/2,000架估算，剩余~252架（12.6%）。按第22天速率（8架/天）可持续约30天，按中等速率（15-26架/天）约10-17天。模式确认伊朗正积极保存无人机库存。第20-22天：15→26→8架，显示战术灵活性和对UAE攻击重点的降低。

---

## 级联阈值追踪

| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | 有 |
...
停火概率降至7%——第22天再创历史新低。连续17天下降趋势（第6天67%→第22天7%）。市场坚定定价持久冲突：开斋节过后仍无停火；卡塔尔拉斯拉凡攻击显示伊朗扩大打击范围；特朗普"结束战争"信号微弱。伊朗对UAE攻击大幅减少（第22天仅11枚）可能反映战略整合而非降级意图。美国轰炸纳坦兹核设施与伊朗向日本提议霍尔木兹通道表明多轨道外交与军事重新定位。
...
**第17天至第22天重大变化：** 第17天DXB因油罐火灾暂停运营，运力暴跌至~30%。第18天GCAA关闭全部领空（第2天以来首次），全天平均~35%。第19-22天部分恢复至~40%，仅阿联酋航空和迪拜航空运营（3月17日起外国航司禁飞DXB）。英航停飞至5月31日；法航暂停；加航至5月1日。印度航司（IndiGo、印度航空）恢复有限服务。模型预测75% vs 实际40%——1.88倍差距持续。第22天低攻击量（11枚，历史第二低）可能促进国际航司逐步恢复。
...
| # | 检查项 | 模型 | 第20天观测 | 第21天观测 | 第22天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | 7枚 | **4枚** | **3枚** | **⚠️ 偏离**（创新最低3枚；非模型预测的"零"而是持续微量） |
| 2 | 拦截率>90%（累计） | 93.2% | ~92.8%（日100%） | **~92.9%（日100%）** | **~92.9%（日100%）** | **⚠️ 稳定**（连续第5天100%日拦截率） |
| 3 | 无人机率~130/天 | ~130/天 | 15/天 | **26/天** | **8/天** | **⚠️ 极端偏离**（−94%；历史最低8架；库存接近耗尽） |
| 4 | 无新武器类型 | 无 | 卡塔尔LNG（区域） | **无新类型** | **纳坦兹核设施（美国反击）** | **偏离**（美国升级进攻，非伊朗新武器） |
| 5 | 停火概率（Polymarket） | 84% | ~10% | **~8%** | **~7%** | **偏离**（历史创新低；特朗普"风险管理"微弱信号） |
| 6 | 机场恢复 | 55%（第12天） | ~45% | **~40%** | **~40%** | **⚠️ 偏离**（模型74% vs 实际40%；停滞；外国航司禁飞） |
| 7 | 无人机库存>30% | ~20% | ~14.3% | **~13.0%** | **~12.6%** | **⚠️ 严重**（~252架剩余；库存枯竭逼近；7-10天耗尽） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | 关闭（~12次通行） | **关闭（~15次通行）** | **关闭（~18次通行）** | **偏离**（选择性通行扩大；日本提议替代通道；事实上开始松动） |
| 9 | 无代理人激活 | P=96%未激活 | 卡塔尔LNG被毁；冲突扩大 | **美国考虑释放伊朗原油** | **迪戈加西亚攻击；美国轰炸纳坦兹** | **偏离**（双向升级；区域冲突全面化） |
| 10 | 判定 | 亚稳态 | 不稳定（λ=2.161） | **不稳定（λ=2.163）** | **不稳定（λ=2.164）** | **偏离**（λ持平2.164；锁定稳定级联；攻击量历史最低无撼动） |

**第20/21天评级：0项吻合，10项偏离**
**第22天评级：0项吻合，10项偏离**

**第20-22天关键动态：** 第22天攻击量暴跌至11枚（3弹道+8无人机）——冲突以来弹道最低和总投射物历史第二低（仅次于第16天10枚）。λ持平于2.164，确认系统锁定在稳定级联状态。矛盾信号集中：(1)美国轰炸伊朗纳坦兹核设施（升级）；(2)伊朗向日本提议霍尔木兹安全通道（选择性封锁运营化）；(3)特朗普考虑"结束战争"（潜在立场转变）；(4)迪戈加西亚遭未遂攻击（打击范围扩展信号）。油价稳定在$95-107。关键担忧：Polymarket停火概率降至7%（历史新低），尽管军事活动大幅减少，市场仍将当前态势视为稳定冲突而非降级。外国航司禁飞持续；撤离运力受限。
