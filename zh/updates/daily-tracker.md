...
逐日6项指标百分比偏差（28天）。红色=实际超出模型，蓝色=实际低于模型。Lambda偏离从第3天起主导（+240% → +360%）。无人机从第11天起极端偏离（实际6-45 vs 模型~130）。弹道导弹在3-15范围内震荡（第12-28天），远超模型接近零的预测。**第31天：11枚弹道+27架无人机（38枚总计）；胡塞武装参战（第2次以色列打击）；曼德海峡受威胁；布伦特$115（月涨幅+55%，史上最快）；DXB改善至60%；停火概率~2%（明日到期）。第30天：16枚弹道+42架无人机（58枚总计）；冲突满一个月；0死1伤；DXB改善至55%；停火概率降至12%。**第29天：20枚弹道+37架无人机；弹道激增6→20；Kezad 1死6伤；WTI触$100。第28天：6枚弹道+9架无人机；中国船被拒霍尔木兹。
...
![Lambda演变](../../charts/lambda_evolution_day30.png)
...
| 指标 | 第1天 | 第3天 | 第5天 | 第7天 | 第8天 | 第9天 | 第10天 | 第11天 | 第12天 | 第13天 | 第14天 | 第15天 | 第16天 | 第17天 | 第18天 | 第19天 | 第20天 | 第21天 | 第22天 | 第23天 | 第24天 | 第25天 | 第26天 | 第27天 | 第28天 | 第29天 | 第30天 | 第31天 | 阈值 |
|------|-------|-------|-------|-------|-------|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------|--------|--------|--------|--------|--------|--------|
| 发射装置消耗 | ~39% | ~50% | ~54% | 85.7% | ~73% | ~67% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | ~99% | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | **~99%** | > 85% |
| 无人机库存 | 89.6% | 65.6% | 53.0% | 40.8% | 34.5% | 28.9% | 23.2% | 21.4% | 19.5% | 18.2% | 16.9% | 15.2% | 14.9% | 13.6% | 16.4%† | 15.1% | 14.3% | **13.0%** | **12.6%** | **11.4%** | **10.6%** | **9.7%** | **9.25%** | **8.7%** | **8.25%** | **6.4%** | **4.3%** | **2.9%** | < 30% |
| 拦截率（累计） | 96.4% | 93.6% | 93.1% | 92.7% | 92.8% | 92.9% | 92.8% | 92.7% | 92.8% | 93.1% | 93.3% | 93.1% | 93.2% | 93.0% | ~92.7% | ~92.7% | ~92.8% | **~92.9%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.0%** | **~93.2%** | **~93.2%** | **~93.2%** | **~93.2%** | < 90% |
| 拦截率（当日） | 96.4% | 100% | 100% | 100% | 93.8% | 94.1% | 91.7% | 88.9% | 100% | 100% | ~100% | 88.9% | 100% | 85.7% | 100% | 100% | 100% | **100%** | **100%** | **100%** | **100%** | **100%** | **N/A（零弹道）** | **100%** | **100%** | **100%** | **100%** | **100%** | < 90% |
| 每日伤亡 | ~22/天 | ~18/天 | ~15/天 | ~16/天 | ~14/天 | ~15/天 | 2/天 | 10/天 | 4/天 | 0/天 | 0/天 | 0/10 | 0/0 | 1/5 | 12 | ~5 | 0 | **3** | **0** | **~2** | **0** | **1** | **0** | **2** | **0** | **7** | **1** | **0** | > 10 |
| 新武器类型 | 无 | 无 | 无 | 无 | 空军基地 | 空军基地 | 空军基地 | 炼油厂 | DXB机场 | 无 | 无 | 无 | 无 | DXB油罐/民用车 | 无 | 无 | 无 | **无** | **无** | **无** | **无** | **无** | **无** | **杰贝阿里港火灾** | **无** | **无** | **无** | **无** | 有 |
...
| # | 检查项 | 模型 | 第27天观测 | 第28天观测 | 第29天观测 | 第30天观测 | 第31天观测 | 状态 |
|---|--------|------|-----------|-----------|-----------|-----------|-----------|------|
| 1 | 弹道导弹单调递减 | 是 | **15枚** | **6枚** | **20枚** | **16枚** | **11枚** | **⚠️ 突破**（第31天：弹道降16→11（−31%）；第26-31天极端波动：0→15→6→20→16→11；无收敛） |
| 2 | 拦截率>90%（累计） | 93.2% | **~93.0%（日100%）** | **~93.2%（日100%）** | **~93.2%（日100%）** | **~93.2%（日100%）** | **~93.2%（日100%）** | **⚠️ 稳定**（连续第13天100%日弹道拦截率；第31天：全部11枚拦截；累计93.2%） |
| 3 | 无人机率~130/天 | ~130/天 | **11/天** | **9/天** | **37/天** | **42/天** | **27/天** | **⚠️ 极端偏离**（第31天降至27架（−36%）；仍−79% vs 模型；无人机库存2.9%终极耗尽阶段） |
| 4 | 无新武器类型 | 无 | **胡塞激活（区域升级）** | **无新类型** | **无新类型** | **无新类型** | **无新类型** | **偏离**（第28-31天无新武器；胡塞武装参战（第31天）；曼德海峡受威胁；双峡风险） |
| 5 | 停火概率（Polymarket） | 84% | **~17%** | **~20%** | **~15%** | **~12%** | **~2%** | **偏离**（第31天降至~2%；合约明日到期；3月停火不可能；胡塞武装参战；远低于84%基准） |
| 6 | 机场恢复 | 55%（第12天） | **~50%** | **~50%** | **~45%** | **~55%** | **~60%** | **⚠️ 偏离**（模型85% vs 实际60%；差距缩小；DXB第11天以来最佳；阿联酋航空+国际航司扩大） |
| 7 | 无人机库存>30% | ~20% | **~8.7%** | **~8.25%** | **~6.4%** | **~4.3%** | **~2.9%** | **⚠️ 危急**（~59架剩余；2-5天内耗尽；终极耗尽阶段；伊朗可能转为纯弹道打击） |
| 8 | 霍尔木兹海峡开放 | P=98%开放 | **关闭（~5航次；伊斯兰革命卫队正式审批）** | **关闭（0航次；中国船被拒）** | **关闭（~2航次；收费系统）** | **关闭（~3航次；收费系统）** | **关闭（~4航次；胡塞威胁曼德海峡）** | **偏离**（第31天：霍尔木兹~4航次；胡塞威胁曼德海峡；双峡风险；布伦特+55%月涨） |
| 9 | 无代理人激活 | P=96%未激活 | **胡塞信号准备加入战争** | **胡塞升级风险锁定** | **美国部队在沙特遇袭** | **伊朗拒绝所有直接谈判** | **胡塞发起第2次以色列打击；正式参战；曼德海峡受威胁** | **激活**（第31天：胡塞武装正式作为代理人参战；双代理人威胁；曼德海峡关闭风险） |
| 10 | 判定 | 亚稳态 | **不稳定（λ=2.172）** | **不稳定（λ=2.118）** | **不稳定（λ=2.114）** | **不稳定（λ=2.110）** | **不稳定（λ=2.113）** | **偏离**（第31天：λ微升2.110→2.113；一月又一天；胡塞武装参战；无人机库存2.9%危急；停火~2%（明日到期）） |
