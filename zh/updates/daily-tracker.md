...
逐日6项指标百分比偏差（28天）。红色=实际超出模型，蓝色=实际低于模型。Lambda偏离从第3天起主导（+240% → +360%）。无人机从第11天起极端偏离（实际6-45 vs 模型~130）。弹道导弹在3-15范围内震荡（第12-28天），远超模型接近零的预测。第29天：20枚弹道+37架无人机（57枚总计）；弹道激增6→20（+233%）；Kezad 1死6伤；WTI触$100；冲突满一个月。第28天：6枚弹道+9架无人机；中国船被拒霍尔木兹；特朗普推迟能源打击10天。
